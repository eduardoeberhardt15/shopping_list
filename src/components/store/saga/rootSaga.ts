...
import { addTodo, load, updateTodo, updateTodoPrice, updateTodoAmount, updateTodoFavorite, deleteTodo, getListAsync } from './sagas';
...
export default function* rootSaga() {
  return yield all([
    ...
    takeLatest(Types.UPDATE_TODO_FAVORITE, updateTodoFavorite),
